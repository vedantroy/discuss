...
const $anyscalar: $anyscalar = $.makeType<$anyscalar>(_.spec, "c08735c4-a624-11ec-b19d-f18279697c95", _.syntax.literal);

type $anyreal = $anyint | $anyfloat | $anynumeric;
const $anyreal: $anyreal = $.makeType<$anyreal>(_.spec, "c08a0ce3-a624-11ec-9aa7-99094181d4dc", _.syntax.literal);

type $anyfloat = $number;
const $anyfloat: $anyfloat = $.makeType<$anyfloat>(_.spec, "c08bc9d3-a624-11ec-bc6f-47d3c346dcc0", _.syntax.literal);

type $anyint = $number | $bigint;
const $anyint: $anyint = $.makeType<$anyint>(_.spec, "c08a6950-a624-11ec-9aeb-c98f15407d42", _.syntax.literal);

type $anynumeric = $decimal | $bigint;
const $anynumeric: $anynumeric = $.makeType<$anynumeric>(_.spec, "c08cd1dd-a624-11ec-b033-550c200e0c9e", _.syntax.literal);
...
const $sequence: $sequence = $.makeType<$sequence>(_.spec, "c08ddfda-a624-11ec-bdfc-c7a8c9672128", _.syntax.literal);
...
const $BaseObject = $.makeType<$BaseObject>(_.spec, "c3f8f7c7-a624-11ec-9f01-af569e578264", _.syntax.literal);
...
export type $Object_c3fc4d9ba62411ec858e5119572450e1λShape = $.typeutil.flatten<$BaseObjectλShape & {
}>;
type $Object_c3fc4d9ba62411ec858e5119572450e1 = $.ObjectType<"std::Object", $Object_c3fc4d9ba62411ec858e5119572450e1λShape, null>;
export type $Object = $Object_c3fc4d9ba62411ec858e5119572450e1
const $Object_c3fc4d9ba62411ec858e5119572450e1 = $.makeType<$Object_c3fc4d9ba62411ec858e5119572450e1>(_.spec, "c3fc4d9b-a624-11ec-858e-5119572450e1", _.syntax.literal);

const Object_c3fc4d9ba62411ec858e5119572450e1: $.$expr_PathNode<$.TypeSet<$Object_c3fc4d9ba62411ec858e5119572450e1, $.Cardinality.Many>, null, true> = _.syntax.$PathNode($.$toSet($Object_c3fc4d9ba62411ec858e5119572450e1, $.Cardinality.Many), null, true);
...
const $FreeObject = $.makeType<$FreeObject>(_.spec, "c4003066-a624-11ec-85a2-897051a9578b", _.syntax.literal);
...
function min(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {args: [{typeId: "c08a0ce3-a624-11ec-9aa7-99094181d4dc", optional: false, setoftype: true, variadic: false}], returnTypeId: "c08a0ce3-a624-11ec-9aa7-99094181d4dc", returnTypemod: "OptionalType", preservesOptionality: true},
    {args: [{typeId: "c08e3bcc-a624-11ec-ac03-ff8345f7da34", optional: false, setoftype: true, variadic: false}], returnTypeId: "c08e3bcc-a624-11ec-ac03-ff8345f7da34", returnTypemod: "OptionalType", preservesOptionality: true},
...
function sequence_reset(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {args: [{typeId: "c5e4a34a-a624-11ec-a5eb-2bac0e1b3681", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
    {args: [{typeId: "c5e4a34a-a624-11ec-a5eb-2bac0e1b3681", optional: false, setoftype: false, variadic: false}, {typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
export { $anyscalar, $anyreal, $anyfloat, $anyint, $anynumeric, bigint, bool, bytes, datetime, decimal, duration, float32, float64, int16, int32, int64, json, $sequence, str, uuid, number, $BaseObject, BaseObject, $Object_c3fc4d9ba62411ec858e5119572450e1, Object_c3fc4d9ba62411ec858e5119572450e1, $FreeObject, FreeObject };
...
type __defaultExports = {
  ...
  "Object": typeof Object_c3fc4d9ba62411ec858e5119572450e1;
...
const __defaultExports: __defaultExports = {
  ...
  "Object": Object_c3fc4d9ba62411ec858e5119572450e1,
