...
export interface Votable extends std.$Object {
  "votes": Vote[];
  "downVotes": number;
  "score": number;
  "upVotes": number;
}
export interface Answer extends Votable {
  "post": Post;
  "user": User;
  "content": string;
  "createdAt": Date;
...
export interface Document extends std.$Object {
  "club": Club;
  "name": string;
  "shortId": string;
}
export interface Identity extends std.$Object {
  "user": User;
}
...
export interface PDFPost extends Post {
  "excerptRect": PDFRect;
  "rects": PDFRect[];
  "document": PDF;
  "anchorIdx": number;
...
export interface PDFRect extends std.$Object {
  "height": number;
  "width": number;
  "x": number;
  "y": number;
